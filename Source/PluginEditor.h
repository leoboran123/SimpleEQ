...
struct FFTDataGenerator
{
    ...
    */
    ...
    {
        // when you change the order, recreate the window, forwardFFT, fifo, fftData
    ...
    int getNumAvaiableFFTDataBlocks() const { return  fftDataFifo.getNumAvaiableForReading(); }
...
struct AnalyzerPathGenerator
{
    ...
    int getNumPathsAvaiable() const
    {
        return pathFifo.getNumAvaiableForReading();
    }
